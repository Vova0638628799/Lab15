...
Suite *lab_test_suite(void)
{
	...
	TCase *student_sortby_year_alphabet;
	...
	student_sortby_year_alphabet = tcase_create("student_sortby_year_alphabet");
	...
	tcase_add_test(student_sortby_year_alphabet, test_sorts_4_students_alphabet);
	tcase_add_test(student_sortby_year_alphabet, test_sorts_1_students_alphabet);
	tcase_add_test(student_sortby_year_alphabet, test_sorts_0_students_alphabet);

	suite_add_tcase(s, student_sortby_year_alphabet);
